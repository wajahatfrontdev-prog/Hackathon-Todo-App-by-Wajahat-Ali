...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function loadTasks() {
      ...
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://animated-journey-jj46jgwxxw9jcgr5-8000.app.github.dev'}/api/tasks`, {
          headers: {
  ...
  async function deleteTask(id: number) {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://animated-journey-jj46jgwxxw9jcgr5-8000.app.github.dev'}/api/tasks/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
